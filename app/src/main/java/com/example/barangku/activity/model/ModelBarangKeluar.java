...
public class ModelBarangKeluar {
    private String id, namaBarang, satuan, keterangan, tanggalKeluar, namaKlien, alamatKlien;
    private long jumlahBarang;

    public ModelBarangKeluar() {
    }

    public ModelBarangKeluar(String id, String namaBarang, String satuan, String keterangan, String tanggalKeluar, String namaKlien, String alamatKlien, long jumlahBarang) {
        this.id = id;
