...
public class ModelPengajuanBarangKeluar {
    private String id, namaBarang, satuan, keterangan, tanggalKeluar, namaKlien, alamatKlien, status;
    private long jumlahBarang;

    public ModelPengajuanBarangKeluar(){}

    public ModelPengajuanBarangKeluar(String id, String namaBarang, String satuan, String keterangan, String tanggalKeluar, String namaKlien, String alamatKlien, String status, long jumlahBarang) {
        this.id = id;
